# Этап 10. Интерфейс PyQt6

<div class="module-badges">
  <span class="module-badge">Модуль 2 + Модуль 3 + Модуль 4</span>
  <span class="module-note">Интерфейс</span>
</div>

::: info Отметка по модулю
Делаем список материалов, добавление/редактирование, обработку ошибок и окно поставщиков.
::: 


## Что делаем

Создаём главное окно приложения и основные пользовательские сценарии.

## Окна приложения

В приложении нужны три части:

1. **Главное окно** — список материалов.
2. **Форма материала** — добавление и редактирование.
3. **Окно поставщиков** — поставщики выбранного материала.
...
Открывается главное окно, отображаются материалы из базы, работает добавление, редактирование и просмотр поставщиков.
